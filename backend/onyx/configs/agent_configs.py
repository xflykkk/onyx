...
AGENT_DEFAULT_RETRIEVAL_HITS = 15
AGENT_DEFAULT_RERANKING_HITS = 10
AGENT_DEFAULT_MAX_VERIFIVATION_HITS = 10
AGENT_DEFAULT_SUB_QUESTION_MAX_CONTEXT_HITS = 8
AGENT_DEFAULT_NUM_DOCS_FOR_INITIAL_DECOMPOSITION = 3
AGENT_DEFAULT_NUM_DOCS_FOR_REFINED_DECOMPOSITION = 5
AGENT_DEFAULT_EXPLORATORY_SEARCH_RESULTS = 5
...
AGENT_DEFAULT_TIMEOUT_LLM_SUBQUESTION_GENERATION = 30  # in seconds
...
AGENT_DEFAULT_TIMEOUT_LLM_INITIAL_ANSWER_GENERATION = 80  # in seconds
...
AGENT_DEFAULT_TIMEOUT_CONNECT_LLM_QUERY_REWRITING_GENERATION = 10  # in seconds  原来是 4
...
AGENT_DEFAULT_TIMEOUT_LLM_QUERY_REWRITING_GENERATION = 30  # in seconds  原来是 6
...
AGENT_DEFAULT_MAX_TOKENS_VALIDATION = 10
