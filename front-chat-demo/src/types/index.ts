...
export interface StreamLogPacket {
  sequence: number;
  timestamp: string;
  packet_type: string;
  data_size: number;
...
export interface StreamLogDetail {
  summary: StreamLogSummary;
  packets: StreamLogPacket[];
  sub_questions: Array<{
    question: string;
    level: string | number;
    num: string | number;
...
export interface StreamLogListItem {
  filename: string;
  file_path: string;
  timestamp: string;
  start_time: string;
...
export interface StreamLogsStats {
  total_logs: number;
...
export interface StreamLogRawContent {
  filename: string;
  raw_content: string;
}
